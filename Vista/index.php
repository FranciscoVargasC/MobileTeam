...
<html lang="es">
<head>
	<title>Login Repocitorio CIT</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="../Vista/images/logo_anzen.png" alt="IMG">
				</div>

				<form class="login100-form validate-form" method="post" action="../Controlador/InicioSession.php">
					<span class="login100-form-title">
						Login Tester
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="nombUsuario" placeholder="Usuario" id="usuario" required>
					...
					<div class="container-login100-form-btn">
                        <input type="submit" onclick = "validation_login()" value="Ingresar" class="login100-form-btn">
					</div>
...
<!--===============================================================================================-->
	<script src="../Vista/vendor/tilt/tilt.jquery.min.js"></script>
	<script >
		$('.js-tilt').tilt({
			scale: 1.1
		})
